                  ...
                  .map(
                    (participant) =>
                      `<li style="display: flex; align-items: center; margin-bottom: 4px;">
                        ...
                        <span class="delete-participant" title="Remove participant" data-activity="${name}" data-participant="${participant}" style="cursor:pointer; margin-left: 8px; color: #c62828; font-size: 1.2em;">&#10006;</span>
                      </li>`
                  )
                  .join("")}
              </ul>
